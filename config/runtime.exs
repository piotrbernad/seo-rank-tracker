...
#
#     PHX_SERVER=true bin/rank_tracker start
#
...
if System.get_env("PHX_SERVER") do
  config :rank_tracker, RankTrackerWeb.Endpoint, server: true
end

config :rank_tracker, RankTrackerWeb.Endpoint,
  http: [port: String.to_integer(System.get_env("PORT", "4000"))]

if auth0_domain = System.get_env("AUTH0_DOMAIN") do
  config :rank_tracker, RankTracker.Auth,
    domain: auth0_domain,
    client_id: System.fetch_env!("AUTH0_CLIENT_ID"),
    client_secret: System.get_env("AUTH0_CLIENT_SECRET"),
    redirect_uri: System.get_env("AUTH0_REDIRECT_URI", "http://localhost:4000/auth/callback"),
...
if config_env() == :prod do
  ...
  config :rank_tracker, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
